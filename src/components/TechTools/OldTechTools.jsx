...
function OldTechTools() {
  ...
  return (
    ...
    >
        ...
        <motion.div className={styles.techIcon} variants={topVariants}><img src={php} alt="PHP" /><span>PHP</span></motion.div>
        ...
        <motion.div className={styles.techIcon} variants={topVariants}><img src={tailwind} alt="Tailwind" /><span>Tailwind</span></motion.div>
        ...
        <motion.div className={styles.techIcon} variants={rightVariants}><img src={netcore} alt="Netcore" /><span>.Net Core</span></motion.div>
        <motion.div className={styles.techIcon} variants={leftVariants}><img src={csharp} alt="Csharp" /><span>C#</span></motion.div>
        <motion.div className={styles.techIcon} variants={bottomVariants}><img src={java} alt="Java" /><span>Java</span></motion.div>
        <motion.div className={styles.techIcon} variants={bottomVariants}><img src={python} alt="Python" /><span>Python</span></motion.div>
        ...
        <motion.div className={styles.techIcon} variants={rightVariants}><img src={androidstudio} alt="Android Studio" /><span>Android Studio</span></motion.div>
        <motion.div className={styles.techIcon} variants={leftVariants}><img src={pycharm} alt="PyCharm" /><span>PyCharm</span></motion.div>
        <motion.div className={styles.techIcon} variants={bottomVariants}><img src={mysql} alt="MySql" /><span>MySql</span></motion.div>
        <motion.div className={styles.techIcon} variants={bottomVariants}><img src={workbench} alt="Workbench" /><span>Workbench</span></motion.div>
        ...
        <motion.div className={styles.techIcon} variants={rightVariants}><img src={arduino} alt="Arduino" /><span>Arduino</span></motion.div>
        <motion.div className={styles.techIcon} variants={leftVariants}><img src={figma} alt="Figma" /><span>Figma</span></motion.div>
    </motion.div>
  )
}
